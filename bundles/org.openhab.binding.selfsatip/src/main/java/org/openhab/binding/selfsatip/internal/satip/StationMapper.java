    ...
    private class PlaylistInputStreamReader implements Consumer<InputStream>
    {
        ...
        public void accept( InputStream inputStream )
        {
            ...
            try
            {
                ...
                {
                    throw new PlaylistFormatException( "Unknown playlist format" );
                }
                ...
                while( line != null )
                {
                    ...
                    if( !line.startsWith( "#" ) && line.length() > 0 )
                    {
                        try
                        {
                            ...
                            {
                                logger.info( "ignoring stream since it doesn't seem to be a SAT-IP URL: {}", line );
                            }
                        }
            ...
            {
                throw new PlaylistFormatException( "Error reading playlist", ioException );
            }
        }
    }
